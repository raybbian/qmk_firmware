...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAKDH] = LAYOUT(
        ...
        RAISE,   KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    QWERTY,  GAMING,  KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SCLN, LOWER,
    ...
    [_QWERTY] = LAYOUT(
        ...
        _______, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    COLEMK,  _______, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, _______,
    ...
    [_LOWER] = LAYOUT(
        ...
        _______, XXXXXXX, KC_LABK, KC_LBRC, KC_LPRN, KC_LCBR, _______, _______, KC_RCBR, KC_RPRN, KC_RBRC, KC_RABK, XXXXXXX, _______,
                                   _______, _______, _______, _______, _______, _______, _______, _______
    ),
    [_RAISE] = LAYOUT(
