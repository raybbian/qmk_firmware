...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAMING] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    XXXXXXX, COLEMK,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, LOWER,
                                   KC_LALT, KC_LGUI, KC_ENT,  KC_SPC,  KC_GRV,  KC_UNDS, KC_MINS, XXXXXXX
    ),
    [_LOWER] = LAYOUT(
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______,
        _______, KC_F11,  KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_PLUS, KC_ASTR, KC_AMPR, KC_F12,  _______,
        _______, XXXXXXX, KC_LABK, KC_LCBR, KC_LPRN, KC_LBRC,                   KC_RBRC, KC_RPRN, KC_RCBR, KC_RABK, XXXXXXX, _______,
        _______, XXXXXXX, KC_GRV,  KC_BSLS, KC_EQL,  KC_TILD, _______, _______, KC_EXLM, KC_MINS, KC_SLSH, KC_PIPE, XXXXXXX, _______,
